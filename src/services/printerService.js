...
export const printTicket = async (device, element) => {
    ...
    if (!service)
        throw new Error("Serviço de impressão não encontrado. Verifique se a impressora é compatível.");
